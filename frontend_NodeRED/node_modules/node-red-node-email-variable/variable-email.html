<script type="text/html" data-template-name="e-mail">
	...
	<div class="form-row">
        <label for="node-input-output"><i class="fa fa-sign-out"></i><span data-i18n="email.label.output"></span></label>
        <input type="checkbox" id="node-input-output" placeholder="once" style="display: inline-block; width:20px; vertical-align:baseline;">
		<span data-i18n="email.label.outputText"></span>
    </div>
	    <div class="form-row">
